...
class GUI:
	...
	def get_next_question(self, window, human_correct, human_total, target, v, RAVEN_folder, file, file_number, ai_correct, ai_total, ai_choice):
		...
		file_number = file_number+1
		file = "RAVEN_"+str(file_number)+"_val.npz"
		...
		inference_instance = Inference(RAVEN_folder, "val", file)
		...
		button = tk.Button(score_frame, text='Next question ->', font=('Helvatical bold', 18), highlightbackground='#E9F5FF', padx=5, pady=5, command=lambda: self.get_next_question(window, human_correct, human_total, target, choice, RAVEN_folder, file, file_number, ai_correct, ai_total, ai_choice))
...
if __name__ == '__main__':
	...
	button = tk.Button(score_frame, text='Next question ->', font=('Helvatical bold', 18), highlightbackground='#E9F5FF', padx=5, pady=5, command=lambda: gui.get_next_question(window, human_correct, human_total, target, choice, RAVEN_folder, file, file_number, ai_correct, ai_total, ai_choice))
	button.place(x=0, y=300)
